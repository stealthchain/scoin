...
// Global state
//
static const uint256 hashGenesisBlockOfficial("0x00000455db5ae59fbe15074b199ad0429a87ec960716b7883649324ba167c68c");
static const uint256 hashGenesisBlockTestNet ("0x00000455db5ae59fbe15074b199ad0429a87ec960716b7883649324ba167c68c");
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "May 10, 1991 I was born!";
        unsigned int nTimeGenesis=1477428604;
        unsigned int nNonceGenesis=895400;

        if (fTestNet)
        {
            pszTimestamp="Octomber 6, 2009 AUEB";
            nTimeGenesis=1477428604;
            nNonceGenesis=895400;
        }
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0xe9eaab5dce2d9596af880b46d2616bdd37c8d9a032a05552f9ab1e0aacd4b4e7"));
        else
            assert(block.hashMerkleRoot == uint256("0xe9eaab5dce2d9596af880b46d2616bdd37c8d9a032a05552f9ab1e0aacd4b4e7"));
